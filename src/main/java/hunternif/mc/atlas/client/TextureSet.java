...
public class TextureSet implements Comparable<TextureSet> {
    ...
    TEST = new TextureSet(false, "TEST", TILE_TEST, TILE_TEST),
        ...
        SNOW_PINES_HILLS = standard(
            "SNOW_PINES_HILLS",
            TILE_SNOW_PINES_HILLS,
            TILE_SNOW_PINES_HILLS2,
            TILE_SNOW_PINES_HILLS3),
        SNOW_HILLS = standard("SNOW_HILLS", TILE_SNOW_HILLS, TILE_SNOW_HILLS2), SNOW = standard(
        ...
        MOUNTAINS = standard(
            "MOUNTAINS", // Has a few trees on top.
            TILE_MOUNTAINS,
            TILE_MOUNTAINS,
            TILE_MOUNTAINS2,
            TILE_MOUNTAINS2,
        ...
        MOUNTAINS_ALL = standard(
            "MOUNTAINS_ALL", // Has everything: naked mountains, trees on top and snow caps
            TILE_SNOW_CAPS,
            TILE_SNOW_CAPS,
            TILE_MOUNTAINS,
            TILE_MOUNTAINS2,
        ...
        SPARSE_FOREST_HILLS = standard(
            "SPARSE_FOREST_HILLS",
            TILE_SPARSE_FOREST_HILLS,
            TILE_SPARSE_FOREST_HILLS2,
            TILE_SPARSE_FOREST_HILLS3),
        ...
        JUNGLE_CLIFFS = standard("JUNGLE_CLIFFS", TILE_JUNGLE_CLIFFS, TILE_JUNGLE_CLIFFS2, TILE_BUSHES_CLIFFS),
        JUNGLE_EDGE = standard(
            "JUNGLE_EDGE",
            TILE_JUNGLE_EDGE,
            TILE_JUNGLE_EDGE2,
            TILE_JUNGLE_EDGE3,
            ...
            TILE_GRASS3,
            TILE_GRASS4),
        JUNGLE_EDGE_HILLS = standard(
            "JUNGLE_EDGE_HILLS",
            TILE_JUNGLE_EDGE_HILLS,
            TILE_JUNGLE_EDGE_HILLS2,
            TILE_JUNGLE_EDGE_HILLS3,
            TILE_HILLS_GRASS,
            TILE_HILLS_GRASS),
        ...
        SAVANNA = standard(
            ...
            TILE_GRASS4,
            TILE_GRASS4),
        SAVANNA_CLIFFS = standard(
            "SAVANNA_CLIFFS",
            TILE_SAVANNA_CLIFFS,
            TILE_SAVANNA_CLIFFS2,
            TILE_SAVANNA_CLIFFS3,
            TILE_CLIFFS),
        PLATEAU_SAVANNA = standard(
            "PLATEAU_SAVANNA",
            TILE_PLATEAU_GRASS,
            TILE_PLATEAU_GRASS,
            TILE_PLATEAU_GRASS2,
        ...
        // Mesa stuff:
        MESA = standard("MESA", TILE_MESA, TILE_MESA2, TILE_MESA3, TILE_MESA4, TILE_SAND_BUSHES),
        ...
        PLATEAU_MESA_TREES = standard("PLATEAU_MESA_TREES", TILE_PLATEAU_MESA, TILE_PLATEAU_MESA2, TILE_PLATEAU_TREES),
        PLATEAU_MESA_TREES_LOW = standard(
            "PLATEAU_MESA_TREES_LOW",
            TILE_PLATEAU_MESA_LOW,
            TILE_PLATEAU_MESA_LOW2,
        ...
        WATER = standard("WATER", TILE_WATER, TILE_WATER2), LAVA = standard("LAVA", TILE_LAVA, TILE_LAVA2),
        ...
        // Village:
        HOUSE = standard("HOUSE", TILE_HOUSE), FENCE = standard("FENCE", TILE_FENCE).stitchTo(HOUSE),
        LIBRARY = standard("LIBRARY", TILE_LIBRARY), SMITHY = standard("SMITHY", TILE_SMITHY),
        L_HOUSE = standard("L-HOUSE", TILE_L_HOUSE), FARMLAND_LARGE = standard("FARMLAND_LARGE", TILE_FARMLAND_LARGE),
        FARMLAND_SMALL = standard("FARMLAND_SMALL", TILE_FARMLAND_SMALL),
        VILLAGE_TORCH = standard("VILLAGE_TORCH", TILE_VILLAGE_TORCH), WELL = standard("WELL", TILE_WELL),
        // VILLAGE_PATH_X = standard("VILLAGE_PATH_X", TILE_VILLAGE_PATH_X),
        // VILLAGE_PATH_Z = standard("VILLAGE_PATH_Z", TILE_VILLAGE_PATH_Z),
        HUT = standard("HUT", TILE_HUT), HOUSE_SMALL = standard("HOUSE_SMALL", TILE_HOUSE_SMALL),
        BUTCHERS_SHOP = standard("BUTCHERS_SHOP", TILE_BUTCHERS_SHOP), CHURCH = standard("CHURCH", TILE_CHURCH),
