...
public class GuiMarkerFinalizer extends GuiComponent {
    ...
    public void initGui() {
        ...
        int allTypesWidth = MarkerTextureMap.instance()
            .getAllTypes()
            .size() * (GuiMarkerInList.FRAME_SIZE + TYPE_SPACING) - TYPE_SPACING;
        ...
        int contentX = 0;
        for (String markerType : MarkerTextureMap.instance()
            .getAllTypes()) {
            ...
            scroller.addContent(markerGui)
                .setRelativeX(contentX);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTick) {
        ...
        drawGradientRect(
            scroller.getGuiX() - TYPE_BG_FRAME,
            scroller.getGuiY() - TYPE_BG_FRAME,
