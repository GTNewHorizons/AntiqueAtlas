 ...
 * <p>
 * If several textures are set for one ID, one will be chosen at random when
...
public class BiomeTextureMap extends SaveData {
    ...
    public ResourceLocation getTexture(Tile tile) {
        ...
        int i = MathHelper.floor_float(
            (float) (tile.getVariationNumber()) / (float) (Short.MAX_VALUE) * (float) (set.textures.length));
