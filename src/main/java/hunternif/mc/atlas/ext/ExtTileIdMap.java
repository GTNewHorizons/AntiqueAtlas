...
public class ExtTileIdMap extends SaveData {
    ...
    // Village:
    TILE_VILLAGE_LIBRARY = "npcVillageLibrary", TILE_VILLAGE_SMITHY = "npcVillageSmithy",
        TILE_VILLAGE_L_HOUSE = "npcVillageLHouse", TILE_VILLAGE_FARMLAND_SMALL = "npcVillageFarmlandSmall",
        TILE_VILLAGE_FARMLAND_LARGE = "npcVillageFarmlandLarge", TILE_VILLAGE_WELL = "npcVillageWell",
        TILE_VILLAGE_TORCH = "npcVillageTorch",
        // TILE_VILLAGE_PATH_X = "npcVillagePathX",
        // TILE_VILLAGE_PATH_Z = "npcVillagePathZ",
        TILE_VILLAGE_HUT = "npcVillageHut", TILE_VILLAGE_SMALL_HOUSE = "npcVillageSmallHouse",
        TILE_VILLAGE_BUTCHERS_SHOP = "npcVillageButchersShop", TILE_VILLAGE_CHURCH = "npcVillageChurch",

        // Nether & Nether Fortress:
        TILE_LAVA = "lava", TILE_LAVA_SHORE = "lavaShore", TILE_NETHER_BRIDGE = "netherBridge",
        TILE_NETHER_BRIDGE_X = "netherBridgeX", TILE_NETHER_BRIDGE_Z = "netherBridgeZ",
        TILE_NETHER_BRIDGE_END_X = "netherBridgeEndX", TILE_NETHER_BRIDGE_END_Z = "netherBridgeEndZ",
        TILE_NETHER_BRIDGE_GATE = "netherBridgeGate", TILE_NETHER_TOWER = "netherTower",
        TILE_NETHER_WALL = "netherWall", TILE_NETHER_HALL = "netherHall", TILE_NETHER_FORT_STAIRS = "netherFortStairs",
    ...
    public String getPseudoBiomeName(int id) {
        return nameToIdMap.inverse()
            .get(id);
    }

    private int findNewID() {
        while (lastID > Short.MIN_VALUE) {
            if (!nameToIdMap.inverse()
                .containsKey(Integer.valueOf(--lastID))) break;
        }
        return lastID;
    }
