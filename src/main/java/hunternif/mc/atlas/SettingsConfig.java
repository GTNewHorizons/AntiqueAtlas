...
public class SettingsConfig {
    ...
    public void load(File file) {
        ...
        doSaveBrowsingPos = config.getBoolean(
        ...
        maxScale = config.getFloat(
            ...
            "Maximum zoom level. The number corresponds to the size of a block on the map relative to the size of\n"
                + "a GUI pixel. Preferrably a power of 2.");
        doScaleMarkers = config.getBoolean(
            "do_scale_markers",
            INTERFACE,
            doScaleMarkers,
            "Whether to change markers size depending on zoom level.");
        doReverseWheelZoom = config.getBoolean(
            "do_reverse_wheel_zoom",
            INTERFACE,
            doReverseWheelZoom,
        ...
        forceChunkLoading = config.getBoolean(
            "force_chunk_loading",
            PERFORMANCE,
            forceChunkLoading,
        ...
        newScanInterval = config.getFloat(
            "area_scan_interval",
            PERFORMANCE,
            newScanInterval,
            1f / 20f,
