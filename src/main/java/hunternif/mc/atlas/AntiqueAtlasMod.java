...
public class AntiqueAtlasMod {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        itemEmptyAtlas = (ItemEmptyAtlas) new ItemEmptyAtlas().setUnlocalizedName("emptyAntiqueAtlas")
    ...
    public void init(FMLInitializationEvent event) {
        ...
        RecipeSorter
            .register("antiqueatlas:atlascloning", RecipeAtlasCloning.class, SHAPELESS, "after:minecraft:shapeless");
